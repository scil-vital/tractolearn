...
def generate_points(
    ...
    """
    Function used to generate new streamlines from an AE model and seed streamlines

    Args:
        output (str): Output path
        name (str): Bundle name
        device (str): cpu or cuda
        model: AE model for streamline compression
        bundle (np.array): Bundle array (N x 256)
        num_generate_points (int): Number of streamline to generate
        atlas_bundle (np.array): Atlas bundle array (N x 256)
        ...
        gmm_n_component (int): Number of GMM components for RS proposal distribution

    Returns:
        (np.array): Generated streamlines
